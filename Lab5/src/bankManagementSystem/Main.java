...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (choice) {
				case 1:
					System.out.print("\nWould you like to create a Savings(1) or Shecking(2) account? \nEnter 1 or 2: ");
					int accountType = scanner.nextInt();
					scanner.nextLine();
					System.out.print("\nEnter name of acount: ");
				...
				case 4:
					...
					System.out.print("\nEnter account number to withdraw funds from: ");
					int fromAccount = scanner.nextInt();
					System.out.print("\nEnter account number to deposit funds to: ");
